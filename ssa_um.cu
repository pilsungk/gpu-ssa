...
int main(int argc, char** argv) {
    ...
    int *x_array;
    cudaMallocManaged(&x_array, NX*NTHREADS*sizeof(int));
    ...
    */
    ...
    float *finalT_array;
    cudaMallocManaged(&finalT_array, NTHREADS*sizeof(float));
    ...
    */
    ...
    ssa_kernel<<<dimGrid, dimBlock>>>(states, x_array, finalT_array);
